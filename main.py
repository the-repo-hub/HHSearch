...
try:
    cookies_file = open(os.path.join(os.path.dirname(os.path.abspath(__file__)), 'cookies.txt'), 'r+')
...
def send_letter(driver: webdriver.Firefox, vac: Vacancy) -> Union[str, bool]:
    ...
    if experience.text != '1–3 года':
        ...
        #summaries = driver.find_elements(By.CSS_SELECTOR, 'span[data-qa="resume-title"]')
...
def main():
    ...
    t1.join()
    #driver.get('https://spb.hh.ru/vacancy/78573234?from=vacancy_search_list')
